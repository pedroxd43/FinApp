...
export function DatePickerModal({ visible, date, onClose, onSelect }: DatePickerModalProps) {
  ...
  const isToday = (d: number) => {
    ...
    return isSameDay(new Date(year, month, d), today);
  };
            ...
            {days.map((d, i) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  onPress={() => setSelected(new Date(year, month, d))}
                >
                  <View style={[styles.dayInner, isSelected && { backgroundColor: colors.primary }]}>
                    <Text
                      style={[
                        ...
                        today && !isSelected && { color: colors.primary, fontFamily: 'Poppins-SemiBold' },
                        isSelected && { color: '#fff', fontFamily: 'Poppins-SemiBold' },
                      ]}
                    >
                      {d}
                    </Text>
