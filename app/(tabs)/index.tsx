...
import { Plus, Receipt, TrendingUp, TrendingDown } from 'lucide-react-native';
    ...
    <View style={[styles.container, { backgroundColor: colors.bg }]}>
      ...
      <View style={styles.quickStats}>
        <View style={[styles.quickCard, { backgroundColor: colors.incomeLight }]}>
          ...
          <Text style={[styles.quickAmount, { color: colors.incomeDark }]}>
        ...
        <View style={[styles.quickCard, { backgroundColor: colors.expenseLight }]}>
          ...
          <Text style={[styles.quickAmount, { color: colors.expenseDark }]}>
      ...
      <View style={styles.filterRow}>
        {filters.map((f) => (
          ...
          >
            <Text style={[styles.filterText, { color: colors.textSecondary }, filter === f.key && { color: '#fff', fontFamily: 'Poppins-SemiBold' }]}>
              {f.label}
            </Text>
          </TouchableOpacity>
        ))}
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <EmptyState
            ...
            subtitle="Presiona el botón + para registrar tu primer movimiento"
          />
        }
